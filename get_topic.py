...
def review_label(review):
    ...
    # model location
    model_lda = r"F:\NUS-NLP Project\UC4-topic modelling\LDA_model_beauty"
    ...
    a_file = open(r"F:\NUS-NLP Project\UC4-topic modelling\dictionary_reviews.pkl", "rb")
    dictionary_out = pickle.load(a_file)
    print(type(dictionary_out))
    a_file.close()
    
    #label dictionary
    b_file = open(r"F:\NUS-NLP Project\UC4-topic modelling\dictionary_labels.pkl", "rb")
