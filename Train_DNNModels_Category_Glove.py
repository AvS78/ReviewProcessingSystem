# -*- coding: utf-8 -*-
"""
Created on Sat Oct 31 19:41:14 2020
...
word_2_vec_glove_path=r"F:\NUS-NLP Project\glove.6B.300d.txt"
...
tk=tensorflow.keras.preprocessing.text.Tokenizer(
    num_words=max_features, #=5000 most frequent 5k words to be kept
    filters='!"#$%&()*+,-./:;<=>?@[\\]^_`{|}~\t\n',
    lower=True,
    split=" "
)
...
x_seq_pad = sequence.pad_sequences(x_seq,maxlen=max_len) 
